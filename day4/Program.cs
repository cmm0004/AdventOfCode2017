...
namespace Day4
{
    ...
    class Program
    {
        public static List<string> puzzleInput => new List<string>
        {
        ...
        {
            var validator = new PassphraseValidator(puzzleInput);
            Console.WriteLine(validator.GetNumValidPassphrases());
            Console.WriteLine(validator.GetNumValidPassphrases_Part2());
            Console.ReadKey();
        }
    }
    ...
    public class PassphraseValidator
    {
        ...
        public PassphraseValidator(List<string>input)
        {
        ...
        {
            int valid = _input.Count;

            foreach (var passphrase in _input)
            {
                var hashset = new HashSet<string>();
                var wordList = passphrase.Split(' ');

                for (int i = 0; i < wordList.Length; i++)
                {
                    if (!hashset.Add(wordList[i]))
                    {
                        valid--;
                        break;
                    }
        ...
        public int GetNumValidPassphrases_Part2()
        {
            int valid = _input.Count;
            ...
            foreach (var passphrase in _input)
            {
                ...
                for (int i = 0; i < wordList.Length; i++)
                {
                    var orderedWord = string.Concat(wordList[i].OrderBy(x => x));

                    if (!hashset.Add(orderedWord))
                    {
                        valid--;
                        break;
                    }
